...
class AlgorithmTests: XCTestCase {
    ...
    func testWhenGivenLinesNeedToCombineLines() throws {
        ...
        let expectedSubLineA = LineRoute(name: line1.name, id: line1.id, idLine: line1.idLine,
                                         line: line1.line, routePoints: Array(line1.routePoints[3...10]),
                                         start: line1.start, stops: Array(line1.stops[1...4]),
                                         end: line1.end, averageVelocity: line1.averageVelocity)
