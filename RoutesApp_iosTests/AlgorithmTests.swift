...
class AlgorithmTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        line1 = LineRoute(name: "01", id: "01", idLine: "Zy8i3x4nQH0os7TaCizc", line: "Lines/4MhlK4IGLhTL6wcf50xk", routePoints: routePoints1, start: routePoints1[0], stops: stops1, end: routePoints1[1], averageVelocity: 20.5)
        // MARK: Route 2
        let routePoints2 = TestResources.points2Array
        let stops2 = TestResources.stops2Array
        line2 = LineRoute(name: "1001", id: "01", idLine: "Zy8i3x4nQH0os7TaCizc", line: "Lines/4MhlK4IGLhTL6wcf50xk", routePoints: routePoints2, start: routePoints2[0], stops: stops2, end: routePoints2[1], averageVelocity: 30.2)
    }
    ...
    func testWhenGivenLinePassThroughOriginAndDestination() throws {
        ...
        let expectedLine = LineRoute(name: line1.name, id: line1.id, idLine: line1.idLine, line: line1.line,
                                     routePoints: Array(line1.routePoints[2...5]), start: line1.start, stops: Array(line1.stops[0...2]), end: line1.end, averageVelocity: line1.averageVelocity)
    ...
    func testWhenGivenLinesNeedToCombineLines() throws {
        ...
        let expectedSubLineA = LineRoute(name: line1.name, id: line1.id, idLine: line1.idLine, line: line1.line,
                                         routePoints: Array(line1.routePoints[3...10]), start: line1.start, stops: Array(line1.stops[1...4]), end: line1.end, averageVelocity: line1.averageVelocity)

        let expectedSubLineB = LineRoute(name: line2.name, id: line2.id, idLine: line2.idLine, line: line2.line,
                                         routePoints: Array(line2.routePoints[5...8]), start: line2.start, stops: Array(line2.stops[1...2]), end: line2.end, averageVelocity: line2.averageVelocity)
    ...
    func testWhenGivenLinesHasOneLineAndCombinedRoute() throws {
        ...
        let expectedSubLineA = LineRoute(name: line1.name, id: line1.id, idLine: line1.idLine, line: line1.line,
                                         routePoints: Array(line1.routePoints[3...10]), start: line1.start, stops: Array(line1.stops[2...4]), end: line1.end, averageVelocity: line1.averageVelocity)

        let expectedSubLineB = LineRoute(name: line2.name, id: line2.id, idLine: line2.idLine, line: line2.line, routePoints: [line2.routePoints[5]], start: line2.start, stops: [line2.stops[1]], end: line2.end, averageVelocity: line2.averageVelocity)
